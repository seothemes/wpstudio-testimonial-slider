...
1. You have a couple of options:
	* Go to Plugins -> Add New and search for "Genesis Testimonials Slider". Once found, click "Install".
...
1. Testimonial slider default styling
2. Testimonial slider integrated in theme
3. Testimonial slider admin panel
...
= 1.1.2 =
* Fixed bug which shows slider always on top onf the content using the shortcode
